            ...
            >
              ...
              <div className="p-6 flex flex-col flex-grow items-center text-center">
                ...
                <motion.button 
                  ...
                  whileTap={{ scale: 0.98 }}
                  className="mt-5 w-full py-3 bg-[#0a0a0a] rounded-full font-bold text-[13px] text-[#d4af37] uppercase tracking-[0.5px] transition-colors group-hover:bg-[#d4af37] group-hover:text-[#0a0a0a] flex justify-center items-center gap-2 shadow-[0_4px_14px_rgba(0,0,0,0.1)]"
                >
                ...
                <div className="flex gap-3 overflow-x-auto pb-2 scrollbar-hide">
                  {product.swatches.map((sw, idx) => (
                    <button
                      ...
                      className={`w-20 h-20 rounded-xl overflow-hidden flex-shrink-0 border-2 transition-all bg-[#fcf8f0] ${selectedVariant === sw
                  ...
                  <div className="flex flex-wrap gap-2">
                    {categoryProducts.map((cp) => (
                      <button
                        ...
                        className={`px-4 py-2 rounded-xl text-[12px] font-bold transition-all border-2 ${activeProductId === cp.id
                  ...
                  <div className="flex flex-wrap gap-2.5">
                    {product.tones.map((tone, idx) => (
                      <button
                        ...
                        className={`flex items-center gap-2 px-4 py-2 rounded-full text-[13px] font-bold transition-all border-2 ${selectedVariant === tone.name
                    ...
                    {product.swatches.map((sw, idx) => {
                      ...
                      return (
                        <button
                          key={idx}
                          onClick={() => setSelectedVariant(sw)}
                          className={`px-5 py-2 rounded-full text-[13px] font-bold transition-all border-2 ${selectedVariant === sw
